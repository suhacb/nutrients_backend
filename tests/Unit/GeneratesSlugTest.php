...
class GeneratesSlugTest extends TestCase
{
    ...
    {
        $nutrient = Nutrient::factory()->create(['name' => 'Vitamin C']);
    ...
    {
        $nutrient = Nutrient::factory()->create(['name' => 'Vitamin B12 (Cobalamin)']);
    ...
    {
        $nutrient = Nutrient::factory()->create(['name' => str_repeat('abcde ', 20)]);
    ...
    {
        Nutrient::factory()->create(['name' => 'Vitamin C']);
        $second = Nutrient::factory()->create(['name' => 'Vitamin C']);
    ...
    public function test_increments_suffix_until_free_slot_found(): void
    {
        Nutrient::factory()->create(['name' => 'Vitamin C']);
        Nutrient::factory()->create(['name' => 'Vitamin C']);
        $third = Nutrient::factory()->create(['name' => 'Vitamin C']);
    ...
    {
        $nutrient = Nutrient::factory()->create(['name' => 'Vitamin C', 'slug' => 'my-custom-slug']);
