...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'source_mappings', type: 'array', items: new OA\Items(ref: '#/components/schemas/NutrientSourcePivot')),
...
class NutrientResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'source_mappings' => $this->whenLoaded('sourceMappings', fn () => NutrientSourcePivotResource::collection($this->sourceMappings)),
