...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'source_nutrients', type: 'array', items: new OA\Items(ref: '#/components/schemas/SourceNutrient')),
...
class NutrientResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'source_nutrients' => $this->whenLoaded('sourceNutrients', fn () => SourceNutrientResource::collection($this->sourceNutrients)),
