        ...
        'nutrients' => [
            ...
            'mappings'     => [
                'properties' => [
                    ...
                    'source_nutrients.id'             => ['type' => 'numeric'],
                    'source_nutrients.external_id'    => ['type' => 'keyword'],
                    'source_nutrients.source.id'      => ['type' => 'numeric'],
                    'source_nutrients.source.name'    => ['type' => 'text'],
